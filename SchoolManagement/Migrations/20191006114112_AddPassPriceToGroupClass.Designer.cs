...
namespace SchoolManagement.Migrations
{
    ...
    [Migration("20191006114112_AddPassPriceToGroupClass")]
    partial class AddPassPriceToGroupClass
    {
            ...
            modelBuilder.Entity("Model.Domain.ParticipantGroupClass", b =>
                {
                    ...
                    b.HasOne("Model.Domain.Pass", "Pass")
                        .WithOne("ParticipantGroupClass")
                        .HasForeignKey("Model.Domain.ParticipantGroupClass", "PassId")
                        .OnDelete(DeleteBehavior.Cascade);
